    ...
    namespace UI{
        namespace CoroutineTween{
            ...
            public:
                ...
                float duration;
                virtual void TweenValue(float floatPercentage)=0;
                virtual bool ValidTarget()=0;
            };

            // Color tween class, receives the
            // TweenValue callback and then sets
            // the value on the target.
            struct ColorTween : public ITweenValue{
                enum ColorTweenMode{
                    All,
                    RGB,
                    Alpha
            ...
            public:
                VOID_VOID_PTR mColorTweenCallback;
